...
class Tournament:
    ...
    === Sample usage ===
    >>> t = Tournament(['Team A', 'Team B', 'Team C']) # fix this by adding teamC to it
    ...
    def __init__(self, teams: List[str]) -> None:
        ...
        self.teams = teams[:] # the same with line 80-82

        # self.teams = []
        # for element in teams:
        #     self.teams.append(element)
    ...
    def record_game(self, team1: str, team2: str,
        ...
        if score1>score2: # then team1 win
